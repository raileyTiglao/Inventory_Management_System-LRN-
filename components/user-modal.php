...
<div id="user-modal" class="hidden flex modal-overlay">
  <div class="bin-tag modal-panel">
    ...
    <form id="user-form" class="p-5 space-y-4">
      ...
      <div id="user-readonly-summary" class="hidden flex items-center gap-4 text-xs bg-overlay/5 border border-border-light rounded-tag px-3 py-2">
      ...
      <div>
        <label class="field-label">Password <span id="user-password-required" class="required-marker">*</span></label>
